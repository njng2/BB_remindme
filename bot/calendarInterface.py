...
#                     functions. they simply do not distinctify themselvesas
...
# user inputs year, month, day, and then we default the time to a "day long" 
# event. Thus, time will always be the same:
def addAssignment(name, date):
    date = "2021-"+date
